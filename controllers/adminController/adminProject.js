...
exports.postUserProject = async (req, res) => {
	try {
		...
		const data = await db.sequelize.query('EXEC dbo.spadmins_postuserproject :userId, :userEmail, :clientId, :clientName, :projectId, :projectName, :assignedOn, :completeBy, :teamMembers, :teamHead, :department', {
			replacements: {
				userId: userId,
